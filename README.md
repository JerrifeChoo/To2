...
<h4>使用方式：</h4>
  <h5>1、TextMeshPro Material Preset选择LiberationSans SD- Vertext材质球</h5>
  ...
  <h5>2、使用描边必须同时打开材质球以及Componet中的开关，描边类型通过材质球属性控制，其他描边参数通过Component控制</h5>  
  ...
  <h5>3、使用阴影类似也须同时打开两边开关，由于颜色值使用的R8B8G8A8不支持HDR故阴影内发光模式</h5>
